...
abstract class Tab {	
	...
	void createChildGroup () {
		...
		childGroup.setText (HelloWorldSWT.getResourceString("Children"));
	...
	void createChildWidgets () {
		...
		add.setText (HelloWorldSWT.getResourceString ("Add"));
		add.setLayoutData(new GridData (GridData.FILL_HORIZONTAL));
		delete = new Button (childGroup, SWT.PUSH);
		delete.setText (HelloWorldSWT.getResourceString ("Delete"));
		...
		clear.setText (HelloWorldSWT.getResourceString ("Clear"));
	...
	void createControlGroup () {
		...
		controlGroup.setText (HelloWorldSWT.getResourceString("Parameters"));
		GridLayout layout = new GridLayout ();
		layout.numColumns = 2;
		controlGroup.setLayout (layout);
		size = new Button (controlGroup, SWT.CHECK);
		size.setText (HelloWorldSWT.getResourceString ("Preferred_Size"));
	...
	void createControlWidgets () {
		...
		code.setText (HelloWorldSWT.getResourceString ("Code"));
		...
		code.addSelectionListener (new SelectionAdapter () {
			public void widgetSelected (SelectionEvent e) {
				...
				shell.setText (HelloWorldSWT.getResourceString ("Generated_Code"));
				...
				editItem.setText (HelloWorldSWT.getResourceString ("Edit"));
				Menu menu = new Menu (bar);
				MenuItem select = new MenuItem (menu, SWT.PUSH);
				select.setText (HelloWorldSWT.getResourceString ("Select_All"));
				...
				copy.setText (HelloWorldSWT.getResourceString ("Copy"));
				...
				exit.setText (HelloWorldSWT.getResourceString ("Exit"));
	...
	void createLayoutGroup () {
		...
		layoutGroup.setText (HelloWorldSWT.getResourceString("Layout"));
	...
	void refreshLayoutComposite () {
		...
		String [] itemValues = new String [] {
			HelloWorldSWT.getResourceString ("Item",new String [] {"1"}),
			HelloWorldSWT.getResourceString ("Item",new String [] {"2"}),
			HelloWorldSWT.getResourceString ("Item",new String [] {"3"})};
		for (int i = 0; i < items.length; i++) {
			String control = items [i].getText (1);
			if (control.equals ("Button")) {
				Button button = new Button (layoutComposite, SWT.PUSH);
				button.setText (HelloWorldSWT.getResourceString ("Button_Index", new String [] {new Integer (i).toString ()}));
				children [i] = button;
				...
				combo.setText (HelloWorldSWT.getResourceString ("Combo_Index", new String [] {new Integer (i).toString ()}));
				children [i] = combo;
				...
				item.setText (HelloWorldSWT.getResourceString ("Item",new String [] {"1"}));
				item = new ToolItem (toolBar, 0);
				item.setText (HelloWorldSWT.getResourceString ("Item",new String [] {"2"}));
		    	CoolItem coolItem1 = new CoolItem (coolBar, 0);
		    	coolItem1.setControl (toolBar);
				toolBar = new ToolBar (coolBar, SWT.BORDER);
				item = new ToolItem (toolBar, 0);
				item.setText (HelloWorldSWT.getResourceString ("Item",new String [] {"3"}));
				item = new ToolItem (toolBar, 0);
				item.setText (HelloWorldSWT.getResourceString ("Item",new String [] {"4"}));
				...
				group.setText (HelloWorldSWT.getResourceString ("Group_Index", new String [] {new Integer (i).toString ()}));
				children [i] = group;
			} else if (control.equals ("Label")) {
				Label label = new Label (layoutComposite, SWT.NONE);
				label.setText (HelloWorldSWT.getResourceString ("Label_Index", new String [] {new Integer (i).toString ()}));
				children [i] = label;
				...
				styledText.setText (HelloWorldSWT.getResourceString ("StyledText_Index", new String [] {new Integer (i).toString ()}));
				children [i] = styledText;			
			} else if (control.equals ("Table")) {
				Table table = new Table (layoutComposite, SWT.BORDER);
				table.setLinesVisible (true);
				TableItem item1 = new TableItem (table, 0);
				item1.setText (HelloWorldSWT.getResourceString ("Item",new String [] {"1"}));
				TableItem item2 = new TableItem (table, 0);
				item2.setText (HelloWorldSWT.getResourceString ("Item",new String [] {"2"}));
				children [i] = table;
			} else if (control.equals ("Text")) {
				Text text = new Text (layoutComposite, SWT.BORDER);
				text.setText (HelloWorldSWT.getResourceString ("Text_Index", new String [] {new Integer (i).toString ()}));
				children [i] = text;
