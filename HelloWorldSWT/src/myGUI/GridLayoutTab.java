...
class GridLayoutTab extends Tab {
	 ...
	 */
	GridLayoutTab(HelloWorldSWT instance) {
		super(instance);
	}
	...
	void createControlWidgets () {
		...
		marginGroup.setText (HelloWorldSWT.getResourceString ("Margins_Spacing"));
		...
		columnGroup.setText (HelloWorldSWT.getResourceString ("Columns"));
